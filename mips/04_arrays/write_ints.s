...
while_i_lt_10:
        ...
        # given an array[10], in memory the distance of one element to 
        # the next, i.e. array[0] to array[1] is 1 word/4 bytes.
        ...
        # basically *(&int_arr + INDEXER) = i * 42
        mul     $t3, $t0, 42                    # i = i * 42
        sw      $t3, ($t2)
        ############################################################################
        ...
        mul     $t3, $t0, 42                    # i = i * 42
        sw      $t3, int_arr($t1)               # offset from &int_arr by $t1 (i * 4) bytes
                                                # *(&int_arr + offset) = i * 42
        ############################################################################
